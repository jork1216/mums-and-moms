...
export default function AnnouncementBar() {
  return (
    <div
      className={`${montserrat.className} h-7 overflow-hidden bg-[#fff1f5] text-[0.72rem] font-medium text-[#4f4f4f]`}
    >
      <div className="announcement-marquee">
        {announcementItems.map((item) => (
          <div key={item} className="flex shrink-0 items-center gap-2 px-8 whitespace-nowrap">
            <svg
              viewBox="0 0 24 24"
              fill="none"
              aria-hidden="true"
